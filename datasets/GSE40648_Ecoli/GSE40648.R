...
#fixing things retroactively 
library(readr)
GSE40648_Ecoli <- read_csv("datasets/GSE40648_Ecoli/GSE40648_Ecoli.csv")
tT <- format_ids(GSE40648_Ecoli)
write.table(tT, "datasets/GSE40648_Ecoli/GSE40648.csv", row.names = F, sep = ",")
